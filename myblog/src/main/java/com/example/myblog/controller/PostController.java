...
public class PostController {
    ...
    //1. 의존성 주입 첫번째 방법 (가장 많이 쓰는 방법)
//    @Autowired
//    PostService postService; //스프링에서 PostService postService = new PostServiceImpl()와 동일
...
//    }
    ...
    public String inserPost(Post post, HttpSession session) {
       try {
    ...
    //비동기 방식으로 호출할 경우, @ResponseBody 사용 필요
...
//            throw new RuntimeException(e);
        ...
        //- 제네릭 관련 첫번째 매개변수의 타입을 <>안에 작성
        //HttpStatus.OK일 때는 ajax의 success 함수로 결과가 출력된다.
