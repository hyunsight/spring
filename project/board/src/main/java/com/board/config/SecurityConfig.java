...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/css/**", "/js/**", "/img/**", "/fonts/**", "/plugins/**").permitAll()
                ...
                .formLogin(formLogin -> formLogin //2. 로그인에 관한 설정
                        ...
                        .usernameParameter("email") //[중요] 로그인 시 id로 사용할 파라미터 이름(내 사이트 맞는 걸로 바꿔줘야 한다.)
...
//                .exceptionHandling(handling -> handling //4. 인증되지 않은 사용자가 리소스에 접근 시 설정
