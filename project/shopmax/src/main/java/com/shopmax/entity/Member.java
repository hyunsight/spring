...
public class Member extends BaseEntity {
    ...
    private Long id; //pk값의 타입은 참조(레퍼런스) 타입 Long으로 지정

    private String name; //String 사이즈를 지정하지 않으면 -> 기본적으로 varchar(255)

    //이메일의 경우, 유니크 제약 조건 필요
    ...
    //JPA에서는 영속성 컨텍스트에 엔티티 객체를 통해 CRUD를 진행하므로 DTO 객체를 반드시 엔티티 객체로 변경시켜줘야 함
