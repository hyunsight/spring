...
public class ThymeleafExController {
    ...
    public String thymeleafExmaple03(Model model) {
    ...
    public String thymeleafExmaple05(Model model) {
        return "thymeleafEx/thymeleafEx05";
    }


    @GetMapping(value = "/ex06")
    public String thymeleafExmaple06(Model model,
    ...
    public String thymeleafExmaple07(Model model) {
        return "thymeleafEx/thymeleafEx07";
    }

    @GetMapping(value = "/ex08")
    public String thymeleafExmaple08(Model model) {
